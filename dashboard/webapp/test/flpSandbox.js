		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#dashboarddashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dashboarddashboard-display": {
								"semanticObject": "dashboarddashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dashboard.dashboard",
									"url": sap.ui.require.toUrl("dashboard/dashboard")
								}
							}
						}
					}
